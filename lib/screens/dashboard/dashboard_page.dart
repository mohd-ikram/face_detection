...
class _DashboardPageState extends State<DashboardPage>
  ...
  Future<void> _predictFacesFromImage({required CameraImage cameraImage}) async{
  ...
  Future<void> detectFacesFromCameraImage(CameraImage cameraImage) async{
    InputImageData inputImageData = InputImageData(size: Size(cameraImage.width.toDouble(),cameraImage.height.toDouble()),
        imageRotation: rotationIntToImageRotation(controller!.description.sensorOrientation),
        inputImageFormat: InputImageFormat.bgra8888, planeData: cameraImage.planes.map((Plane plane) {
    ...
    InputImage visionImage = InputImage.fromBytes(bytes: cameraImage.planes[0].bytes,
